                    ...
                    <div class="col-md-4 product-left p-left">
                        <div class="product-main simpleCart_shelfItem">
                            <a href="/product/<?= $product->alias; ?>" class="mask">
                                <img class="img-responsive zoom-img" src="/images/<?= $product->img?>" alt="<?= $product->title?>" /></a>
                            <div class="product-bottom">
                                ...
                                <h4><a data-id="<?= $product->id; ?>" class="add-to-cart-link" href="/cart/add?id=<?= $product->id; ?>"><i></i></a>
                                    <span class=" item_price" data-base="<?= $product->price * $currency['value']; ?>">
                            ...
                            <div class="srch srch1">
                                <span><?php if($product->old_price && $product->old_price > $product->price): ?>
